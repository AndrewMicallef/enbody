...
const int dim = {{dim}};
uniform mat4 transform; // transform matrix that represent the camera fov / angle
...
{
    vpos = transform_projection * transform *vertex_position;
    return vpos;
}
#endif
